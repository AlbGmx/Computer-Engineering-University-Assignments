...
HD_PWD='C:/Users/Alberto/Vivado/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_ALU.tcl
