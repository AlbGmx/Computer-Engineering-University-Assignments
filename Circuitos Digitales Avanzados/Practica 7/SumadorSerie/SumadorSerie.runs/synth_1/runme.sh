...
HD_PWD='C:/Users/Alberto/Vivado/SumadorSerie/SumadorSerie.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sumador_Serie_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sumador_Serie_tb.tcl
