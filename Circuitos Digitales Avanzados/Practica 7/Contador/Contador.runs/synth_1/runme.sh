...
HD_PWD='C:/Users/Alberto/Contador/Contador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ContadorModuloM_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ContadorModuloM_tb.tcl
