...
HD_PWD='C:/Users/Alberto/RegistroDesplazamiento/RegistroDesplazamiento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RegistroDesplazamiento.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RegistroDesplazamiento.tcl
