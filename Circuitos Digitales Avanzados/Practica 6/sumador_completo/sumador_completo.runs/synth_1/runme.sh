...
HD_PWD='C:/Users/Alberto/Vivado/sumador_completo/sumador_completo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador_completo_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador_completo_tb.tcl
