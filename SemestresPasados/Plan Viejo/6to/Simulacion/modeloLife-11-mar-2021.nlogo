...
to cross
  ...
  let y 0
  loop[
    ask patches [if pxcor = x and y = pycor
      [cell-birth]]
    ask patches [if pxcor = x and y = -1 * pycor
      [cell-birth]]
    ask patches [if pxcor = x + y and pycor = 0
      [cell-birth]]
    ask patches [if pxcor = x - y and pycor = 0
      [cell-birth]]
...
to diagonalCross
  ...
  let y 0
  loop[
    ask patches [if (pxcor = x + y ) and y = pycor
      [cell-birth]]
    ask patches [if (pxcor = x - y) and y = -1 * pycor
      [cell-birth]]
    ask patches [if (pxcor = x + y ) and y = -1 * pycor
      [cell-birth]]
    ask patches [if (pxcor = x - y) and y = pycor
