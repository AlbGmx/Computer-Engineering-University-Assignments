...
public class PseudoParser {
   ...
   private boolean variable() {
      ...
      if (token("VARIABLE")) {
         ...
         table.define(vs);
         output.concat(bit.getName() + " " + vsName + ";\n");
         return true;
      }
