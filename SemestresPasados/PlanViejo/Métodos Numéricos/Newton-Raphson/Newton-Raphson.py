...
def NewtonRaphson(equation, start, error, iterations):
  aproxError = 100
  xOld = 0
  fx = 0
  fdx = 0
  ...
  i = 1
  print("-------------------------------------------------------------------------------------------------------------")
  print("{:>4} {:>25} {:>25} {:>25}".format(
      "Iteraciones", "f(x)", "f'(x)", "Error Aproximado"))
  print("-------------------------------------------------------------------------------------------------------------")
  x = start
  while((iterations != 0) & (aproxError > error)):
    ...
    xOld = x
    print("{:>4} {:>32} {:>25} {:>25}".format(i, fx, fdx, aproxError))
    i = i + 1
    iterations=iterations-1
  return x

#Obtener derivada de una funciondada
...
root = NewtonRaphson(equation, start, error, iterations)
