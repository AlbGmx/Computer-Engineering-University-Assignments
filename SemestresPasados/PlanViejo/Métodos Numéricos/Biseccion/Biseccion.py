...
def bisection(equation, a, b, iterations, error):
  aproxError = 100
  xs = 0
  xsa = 0
  i = 1
  if((evaluateFunction(equation,a)*evaluateFunction(equation,b)) >= 0):
    return ("No hay raiz")
  print("\n\n-------------------------------------------------------------------------------------------------------------")
  print("{:>4} {:>18} {:>25} {:>25} {:>25}".format("Iteraciones", "a", "b", "xs", "Error Aproximado"))
  print("-------------------------------------------------------------------------------------------------------------")
...
rootBisection = bisection(equation, start, end, iterations, error)
print("\n\n-------------------------------------------------------------------------------------------------------------")
print("\tRaiz aproximada usando el metodo de biseccion: ", rootBisection)
print("-------------------------------------------------------------------------------------------------------------")